...
<html lang="en" class="no-js">
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background: #cc0000">
    <div class="text-block">
      <div class="container">
        <div class="row">
...
<p style="text-align: justify">In marketing, lead generation is the initiation of consumer interest or enquiry into products
or services of a business. Leads can be created for purposes such as list building, e-
newsletter list acquisition or for sales leads.
  </p>
...
<div class="text-l service-desc- pr25">
  <h3 style="color:#000">Lead Generation Includes</h3>
	<h5 class="mt10 mb20"></h5><p>However, a growth plan focuses specifically on expansion and how you&#39;re going to achieve
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 style="color:#000">PPC advertising services and it’s benefits</h3>
	<h5 class="mt10 mb20"></h5><p>Pay-per-click (PPC) marketing is a type of online marketing done through platforms like
Google Ads, Facebook, and Bing. You (the advertiser) will only pay for clicks, or when a user
clicks through to your desired landing page. It&#39;s a way of buying traffic to your website vs.
earning visitors through organic methods, like SEO.</p>
  <ul class="service-point-2 mt20">
...
<div class="text-l service-desc- pr25">
  <h3 style="color:#000">Search engine marketing and benefits</h3>
	<h5 class="mt10 mb20"></h5><p>Search engine marketing is the practice of marketing a business using paid advertisements
that appear on search engine results pages (or SERPs). Advertisers bid on keywords that
users of services such as Google and Bing might enter when looking for certain products or
services, which gives the advertiser the opportunity for their ads to appear alongside results
for those search queries.</p>
  <ul class="service-point-2 mt20">
