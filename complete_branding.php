...
<!--End Header -->
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background:#0814f7">
    <div class="text-block">
      <div class="container">
        <div class="row">
...
<div class="text-l service-desc- pr25">
	...
	<br>
<p style="text-align: justify">A brand is an ultimate commitment that businesses devote to their customers/consumers.Brand earns you reliance and makes your consumers choose you over others. As a matter of fact, effective branding could well be the key factor which decides whether businesses succeed or die! A brand is your individuality by all five senses! Branding is the critical element that defines a business and gains a solid berth in the business world.</p>
						...
						<div class="row justify-content-center">
							<div class="col-lg-8">
								<div class="common-heading ptag">
									...
									<h2>Why Choose Webingo for your company’s branding:</h2>
						...
						<div class="row justify-content-center">
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									<div class="s-card-icon"><img src="images/icons/technical-support.png" alt="service" class="img-fluid"></div>
									<div class="s-block-content">
										<h4>Complete Technical Competency</h4>
										<p>
We have complete command over technology we use for great results.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Friendly and Cordial in Nature</h4>
										<p>
Our Team learns your needs with the same comfort you feel with your friends.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>
We deliver the best on time, so that your business can do the best on the earliest</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s" style="visibility: visible; animation-delay: 1.1s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Effective and Continuous Communication</h4>
										<p>
We are always ready for communicate to help and understand you</p>
									</div>
								</div>
							</div>
				...
				<div class="servie-key-points">
				  ...
				  <ul class="key-points mt20">
					  ...
					  <li>&amp; Many more as per your requirements</li>
				  </ul>
				</div>
				</div>
				<div class="col-lg-7">
				<div class="text-l service-desc- pr25">
				  <h3 class="mb20">Branding Includes</h3>  
        ...
        <div class="col-md-6 mt60">
          <div id="accordion" class="accordion">
            <div class="card-1">
              ...
              Can I get a customised graphic design service?
                </button>
              </div>
              <div id="collapse-a" class="card-body collapse " aria-labelledby="faq1" data-parent="#accordion">
                <p>
Yes, definitely. WEBINGO offers a wide range of options in it’s wide range of Graphic Designing Services. Describe them your requirement and they will provide you with the best possible solution.</p>
              </div>
            </div>
           <div class="card-1 ">
