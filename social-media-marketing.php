...
<div class="container">
    ...
    <blockquote>
      <p>Social media is not just an activity; it is an investment of valuable time and resources.</p>
      <footer>
...
<div class="text-l service-desc- pr25">
	...
	<h2>SMM in India</h2>
	<br>
<p style="text-align: justify">Your websites’ performance always have a greater impact on your business and due to that
reason, the importance for an effective search engine optimisation is so crucial and it grows
every day.Even if you are conducting a simple and small improvement in your ranking, then
that will surely give you more traffic to reach out more potential customers. When you
know that it is all about the visibility of your online brand, having an attractive website is
always a significant option to choose.</p>
...
<img src="images/smm.png" alt="image" class="img-fluid no-shadow">
</div>
</div>
</div>
</div>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 style="color:#050748">What is Social Media Marketing?</h3>
...
your results, and running social media advertisements.,</p>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3>Social Advertisement and benefits</h3>
  <h5 class="mt10 mb20">Hire Expert Cross Platform Mobile App Developers to Boost Your Business</h5>
  <p>Social advertising is the process of creating and deploying clickable ads to reach target
audiences through social media platforms, messaging apps, news feeds, and even outside
apps and websites. Companies use social advertising campaigns to build brand awareness,
generate leads, and/or capture sales revenue.</p>
  <ul class="service-point-2 mt20">
		<li># Improved Brand Recognition</li>
		<li># Improved Brand Loyalty</li>
		<li># Improved Conversion Rates</li>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 style="color:#050748">Social Monitoring and benefits</h3>
  <h5 class="mt10 mb20">Hire Expert Cross Platform Mobile App Developers to Boost Your Business</h5>
  <p>

Social monitoring, also known as social media monitoring, social media measurement, or
social listening, is the process of tracking content on social media sites, blogs, news sites,
wikis, forums, message boards, and other websites as a way to find out what people are
saying about your brand, your competitors, your industry, your products or services, and
just about anything else you’re looking to learn about.</p>
...
<div class="servie-key-points">
  <h4>Testing Methods we follow</h4>
  <ul class="key-points mt20"> 
	<li>Respond to customers’ complaints promptly, avoiding the escalation of differences.</li>
<li>Improve your online image and your brand by showing that you care and you are interested
in your customers.</li>
<li>Promote and initiate discussions around your brand to increase awareness of your products
and services.</li>
<li>Gain the feedback you need to help and develop your products and services that match your
customers’ needs.</li>
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20"> 
	<li>Traffic</li>
<li>Increased Value Perception</li>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3>Strategies to promote offer and encourage sale</h3>
  <h5 class="mt10 mb20">Hire Expert Cross Platform Mobile App Developers to Boost Your Business</h5>
  <p>
...
This strategy is usually brought to use in the following cases –</p>
  <ul class="service-point-2 mt20">
	  <li># to introduce new products,</li>
	<li># Social Monitoring</li>
	<li># attract more customers, and</li>
	<li># to lift sales temporarily.</li>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 style="color:#050748">Virtual Marketing</h3>
  <h5 class="mt10 mb20">Hire Expert Cross Platform Mobile App Developers to Boost Your Business</h5>
  <p>
...
to promote a product. Its name refers to how consumers spread information about a
product with other people, much in the same way that a virus spreads from one person to
another.</p>
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20">
	  ...
	  <li>Reach consumers at every stage of their buying consideration process.</li>
	<li>Clearly recognize what Social Media success looks like.</li>
	<li>Create a powerful internal process to create, collect and publish useful content, including
	online reviews.</li>
	<li>Uncover opportunities to generate leads and sales.</li>
	<li>Establish consistent “Best Practices."</li>
...
A social media audit is a series of steps taken to evaluate and optimize a business's social
media profiles and strategies. Performing a social media audit can help ecommerce
businesses stay on top of their online presence.</p>
 ...
 <section class="why-choos-lg bg-gradient15 pad-tb deep-dark">
<div class="container">
	<div class="row justify-content-center">
	<div class="col-lg-8">
		<div class="common-heading ptag">
			<span class="text-radius text-light text-animation bg-b">We Deliver Our Best</span>
			<h2>How WEBINGO does your Social Media Handling?</h2>
...
<div class="itm-media-object mt40">
	<div class="media">
		...
		<div class="media-body">
			...
			<h4>Researching your target audience</h4>
...
optimisation, social media marketing, ppc advertising .</p>
	...
	<div class="media mt40">
		...
		<div class="media-body">
			<h4> Creating your social media strategy</h4>
...
<div class="itm-media-object mt40">
	<div class="media">
		<img src="images/icons/computers.svg" alt="icon">
		<div class="media-body">
			<h4>Designing your social media accounts</h4>
...
<div class="common-heading ptag">
<span>Service</span>
<h2>Why WEBINGO for SMM?</h2>
<p class="mb30">Unlike other SMO organizations, WEBINGO always focuses on the return on investment
digital advertisingto guaranteeeconomic outcome for the moneymaking establishment.</p>
</div>
</div>
</div>
							...
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4 style="font-size: 15px">Valuable Services – We Offer</h4>
...
Adhering to Quality Policy across all the processes, internal communication and outcomes
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s" style="visibility: visible; animation-delay: 1.1s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4 style="font-size: 15px"> Social Listening & Audit</h4>
										<p>
...
Explore a new world of innovation, technology, and business intelligence.
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									<div class="s-card-icon"><img src="images/icons/tech.svg" alt="service" class="img-fluid"></div>
									<div class="s-block-content">
										<h4 style="font-size: 13px">Improving Your Knowledge & Skill Base</h4>
										<p>
