...
<html lang="en" class="no-js">
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background: #0712df">
    <div class="text-block">
      <div class="container">
        <div class="row">
...
<div class="row">
    ...
    <blockquote>
      <p>Planning is bringing the future into the present so that you can do something about it
now</p>
      <footer>
      - Alan Lakein
      </footer>
...
Analysing the attributes of your customers can assist with ensuring your product/service features,strategy are compatible with your</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 mt30">
