...
<html lang="en" class="no-js">
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background:#1496DD">
    <div class="text-block">
      <div class="container">
        <div class="row">
...
automate the way how designers think.</p>
  ...
  <!--End Breadcrumb Area-->
	  <section class="about-sec-rpb pad-tb" style="padding-bottom:20px">
<div class="container">
<div class="row justify-content-center text-center">
<div class="col-lg-10">
<div class="common-heading">
<span>Graphic Designs are a way of saying who you or what you do without saying anything</span>
<h1 class="mb30"><span class="text-second">Innovation</span>Through Automation </h1>
<p>Design principles do not change over time. The wheel isn't constantly reinvented. The way how graphic designs are designed today, can be changed though. We are convinced that professional graphic designs can be automated. That's what we do. We automate the way how designers think
</p>
...
<div class="s-block-content-large">
  ...
  <p>
Corporate identity includes all of a company's visual aspects and design elements, reaching from logos to social media assets and stationery. Brand image is instantly recognizable due to a strong corporate identity, and this creates a lasting impression for customers</p>
</div></div>
</div>
...
<div class="s-block wide-sblock">
  ...
  <div class="s-block-content-large">
    ...
    <p>A dynamic logo is an adaptable logo – one that changes depending on the context in which it's placed. Unlike “static” (read: regular) logos, dynamic logos are meant to be transformed</p>
  </div></div>
</div>
<div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
  <div class="s-block wide-sblock">
    ...
    <div class="s-block-content-large">
      ...
      <p>Social Media Poster offers users an easy way to draft, schedule, and post content on Facebook (Business pages), LinkedIn, Instagram (scheduling only, no posting), Pinterest and Twitter without leaving the SEMrush interface.</p>
    </div></div>
  </div>
  <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
    <div class="s-block wide-sblock">
      ...
      <div class="s-block-content-large">
        ...
        <p>Business presentation can be defined as formal information about the business products or practices. It is typically carried out by using the audio and visual presentation material such as statistical documents, projectors, flip charts, whiteboards, and much more.</p>
      </div></div>
    </div>
    <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeInUp;">
      <div class="s-block wide-sblock">
        ...
        <div class="s-block-content-large">
          ...
          <p>You can Outsource your Projects and we would be happy to help keeping in mind it brings benefits to both each of u</p>
        </div></div>
      </div>
      <div class="col-lg-6 col-md-12 mt30 wow fadeInUp" data-wow-delay="1.2s" style="visibility: visible; animation-delay: 1.2s; animation-name: fadeInUp;">
        <div class="s-block wide-sblock">
          ...
          <div class="s-block-content-large">
            ...
            <p>We don’t just stop at designing for you, we also provide you with printing services of the best quality at the best price.</p>
          </div></div>
        </div>
      </div>
...
<div class="row">
<div class="col-lg-8 col-sm-8 mt60 wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
<div class="isotope_item hover-scale">
<div class="item-image" data-tilt="" data-tilt-max="2" data-tilt-speed="1000" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
	<a href="#"><img src="images/image-d.jpg" alt="image" class="img-fluid"> </a>
</div>
<div class="item-info">
...
<div class="col-lg-4 col-sm-4 mt60 wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
<div class="isotope_item hover-scale">
<div class="item-image" data-tilt="" data-tilt-max="2" data-tilt-speed="1000">
	<a href="#"><img src="images/image-1.jpg" alt="image" class="img-fluid"> </a>
</div>
<div class="item-info">
...
<div class="col-lg-4 col-sm-4 mt60 wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
<div class="isotope_item hover-scale">
<div class="item-image" data-tilt="" data-tilt-max="2" data-tilt-speed="1000">
	<a href="#"><img src="images/image-6.jpg" alt="image" class="img-fluid"> </a>
</div>
<div class="item-info">
...
<div class="col-lg-8 col-sm-8 mt60 wow fadeInUp" data-wow-delay="0.8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
<div class="isotope_item hover-scale">
<div class="item-image" data-tilt="" data-tilt-max="2" data-tilt-speed="1000">
	<a href="#"><img src="images/image-c.jpg" alt="image" class="img-fluid"> </a>
</div>
<div class="item-info">
...
<div class="itm-media-object mt40">
	<div class="media">
		...
		<div class="media-body">
			...
			<p>A design that is recognised and trusted will bring in more sales and profits because people will trust your brand.</p>
		</div>
	</div>
	<div class="media mt40">
		...
		<div class="media-body">
			...
			<p>The brand image that a company achieves is a powerful tool for gaining market leverage; when a company has created a positive brand image, it can influence its target audience's buying habits.</p>
		</div>
	</div>
	<div class="media mt40">
		...
		<div class="media-body">
			...
			<p>A design helps increase your market value which is directly proportional to the stock prices.</p>
		</div>
	</div>
</div>
</div>
...
<div class="itm-media-object mt40">
	<div class="media">
		...
		<div class="media-body">
			...
			<p>
The more highly customers think of your product or service, the more they are willing to pay for it and even to buy from you. Maintaining your perceived quality status also can prevent customers from trying a competitor’s offering.</p>
		</div>
	</div>
	<div class="media mt40">
...
If a person remembers about your logo, they automatically trust you are more likely to involve with your product/services.</p>
	...
	<div class="page_div pad-tb"><section id="logo-design-packages" class="page logo-design-packages text-black" style="background-color: #fff; min-height: 528px;"><div class="container"><div class="col-lg-12">
		<div class="common-heading ptag">
			<span class="text-radius text-light text-animation bg-b">Our Best Price</span>
			<h2>Pricing </h2>
...
<div class="packages_tabs">
	...
	</div> <div style="margin-top: 20px"></div><div class=" align-left" style="color:;">

<style type="text/css">div.p_table_1#medicenter_orange-1-logo-INR h2, div.p_table_1#medicenter_orange-1-logo-INR h2 span{font-family: "Open Sans" !important;font-size: 24px !important;}div.p_table_1#medicenter_orange-1-logo-INR h1, div.p_table_1#medicenter_orange-1-logo-INR h1 span{font-family: "Open Sans" !important;font-size: 42px !important;}div.p_table_1#medicenter_orange-1-logo-INR h3{font-family: "Open Sans" !important;}div.p_table_1#medicenter_orange-1-logo-INR li.row_style_1 span, div.p_table_1#medicenter_orange-1-logo-INR li.row_style_2 span, div.p_table_1#medicenter_orange-1-logo-INR li.row_style_3 span, div.p_table_1#medicenter_orange-1-logo-INR li.row_style_4 span{font-family: "Open Sans" !important;}div.p_table_1#medicenter_orange-1-logo-INR a.sign_up, div.p_table_1#medicenter_orange-1-logo-INR .css3_grid_hidden_rows_control span{font-family: "Open Sans" !important;}</style><style type="text/css">@media screen and (max-width:1009px)
			{div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_3_responsive
						{
							height: 31px !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_4_responsive
						{
							height: 31px !important;
						}}@media screen and (max-width:767px)
			{div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_0_responsive
						{
							height: 30px !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_2_responsive
						{
							height: 30px !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_3_responsive
						{
						...
						{
							height: 49px !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_5_responsive
						{
							height: 31px !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_6_responsive
						{
							height: 31px !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_7_responsive
						{
							height: 55px !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_8_responsive
						{
							height: 55px !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR a.sign_up
				{
					width: 75px;
				}div.p_table_1#medicenter_orange-1-logo-INR h2, div.p_table_1#medicenter_orange-1-logo-INR h2 span{font-size: 18px !important;}div.p_table_1#medicenter_orange-1-logo-INR h1, div.p_table_1#medicenter_orange-1-logo-INR h1 span{font-size: 42px !important;}}@media screen and (max-width:479px)
			{div.p_table_responsive#medicenter_orange-1-logo-INR div.column_1_responsive
						{
							width: 33% !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR div.column_2_responsive
						{
							width: 33% !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR div.column_3_responsive
						{
							width: 33% !important;
						}div.p_table_responsive#medicenter_orange-1-logo-INR li.css3_grid_row_3_responsive
						{
				...
				{
					width: 70px;
				}div.p_table_1#medicenter_orange-1-logo-INR h1, div.p_table_1#medicenter_orange-1-logo-INR h1 span{font-size: 24px !important;}div.p_table_1#medicenter_orange-1-logo-INR li.row_style_1 span, div.p_table_1#medicenter_orange-1-logo-INR li.row_style_2 span, div.p_table_1#medicenter_orange-1-logo-INR li.row_style_3 span, div.p_table_1#medicenter_orange-1-logo-INR li.row_style_4 span{font-size: 7px !important;}}</style><style type="text/css">@media screen and (max-width:767px)
{
...
}</style><div id="medicenter_orange-1-logo-INR" class="p_table_responsive p_table_hide_caption_column p_table_1 p_table_1_15 css3_grid_clearfix p_table_hover_light"><div class="caption_column column_0_responsive" style="width: 25%;"><ul><li class="css3_grid_row_0 header_row_1 align_center css3_grid_row_0_responsive radius5_topleft"><span class="css3_grid_vertical_align_table" style="background-color: #f5f5f5;"><span class="css3_grid_vertical_align" ></span></span></li><li class="css3_grid_row_1 header_row_2 css3_grid_row_1_responsive" ><span class="css3_grid_vertical_align_table" ><span class="css3_grid_vertical_align"><h2 class="caption">Choose <span>Your</span> Plan</h2></span></span></li><li class="css3_grid_row_2 row_style_4 css3_grid_row_2_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption">Logo Design Concepts</span></span></span></span></li><li class="css3_grid_row_3 row_style_2 css3_grid_row_3_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption">Revision Rounds</span></span></span></span></li><li class="css3_grid_row_4 row_style_4 css3_grid_row_4_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption">Numbers of Professional Designers</span></span></span></span></li><li class="css3_grid_row_5 row_style_2 css3_grid_row_5_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption">Redraws</span></span></span></span></li><li class="css3_grid_row_6 row_style_4 css3_grid_row_6_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption">Business Card</span></span></span></span></li><li style="height: 25px;" class="css3_grid_row_7 row_style_2 css3_grid_row_7_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption">Stationery design: Letter Head &amp;Envelope</span></span></span></span></li><li style="height: 25px;" class="css3_grid_row_8 row_style_4 css3_grid_row_8_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption">Dedicated Account Manager</span></span></span></span></li><li style="height: 0px;display: none;" class="css3_grid_row_9 row_style_2 css3_grid_row_9_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"><b>Final Payment Paypal</b></span></span></span></span></li><li class="css3_grid_row_10 footer_row css3_grid_row_10_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"></span></span></li></ul></div><div class="column_1 column_1_responsive" style="width: 25%;"><ul><li class="css3_grid_row_0 header_row_1 align_center css3_grid_row_0_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><h2 class="col1">BASIC</h2></span></span></li><li class="css3_grid_row_1 header_row_2 css3_grid_row_1_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><h1 class="col1" style="font-size:30px !important;">Rs.<span style="font-size:30px !important;">2,999</span></h1></span></span></li><li class="css3_grid_row_2 row_style_3 css3_grid_row_2_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>2</span></span></span></li><li class="css3_grid_row_3 row_style_1 css3_grid_row_3_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>Up to 3 Revisions</span></span></span></li><li class="css3_grid_row_4 row_style_3 css3_grid_row_4_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>1</span></span></span></li><li class="css3_grid_row_5 row_style_1 css3_grid_row_5_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>-</span></span></span></li><li class="css3_grid_row_6 row_style_3 css3_grid_row_6_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>❌</span></span></span></li><li style="height: 25px;" class="css3_grid_row_7 row_style_1 css3_grid_row_7_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>❌</span></span></span></li><li style="height: 25px;" class="css3_grid_row_8 row_style_3 css3_grid_row_8_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>❌</span></span></span></li><li style="height: 0px;display: none;" class="css3_grid_row_9 row_style_1 css3_grid_row_9_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"><b></b></span><a href="https://www.thewebgen.com/packages/?plan=1&amp;services=logo" class="sign_up" radius3="">Buy Now</a></span></span></span></li><li class="css3_grid_row_10 footer_row css3_grid_row_10_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><a href="https://www.thewebgen.com/services/?plan=1&amp;type=package&amp;postid=2387&amp;service=Basic Package" class="sign_up we">Get Started Now</a></span></span></li></ul></div>
			
			<div class="column_2 active_column column_2_responsive" style="width: 25%;"><ul><li class="css3_grid_row_0 header_row_1 align_center css3_grid_row_0_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align">
			<h2 class="col2">STARTUP</h2></span></span></li><li class="css3_grid_row_1 header_row_2 css3_grid_row_1_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><h1 class="col1" style="font-size:30px !important;">Rs.<span style="font-size:30px !important;">5,999</span></h1></span></span></li><li class="css3_grid_row_2 row_style_4 css3_grid_row_2_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>5</span></span></span></li><li class="css3_grid_row_3 row_style_2 css3_grid_row_3_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>Up to 10 Revisions</span></span></span></li><li class="css3_grid_row_4 row_style_4 css3_grid_row_4_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>2</span></span></span></li><li class="css3_grid_row_5 row_style_2 css3_grid_row_5_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>1</span></span></span></li><li class="css3_grid_row_6 row_style_4 css3_grid_row_6_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>❌</span></span></span></li><li style="height: 25px;" class="css3_grid_row_7 row_style_2 css3_grid_row_7_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>❌</span></span></span></li><li style="height: 25px;" class="css3_grid_row_8 row_style_4 css3_grid_row_8_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>✔️</span></span></span></li><li style="height: 0px;display: none;" class="css3_grid_row_9 row_style_2 css3_grid_row_9_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"><b></b></span><a href="https://www.thewebgen.com/packages/?plan=2&amp;services=logo" class="sign_up" radius3="">Buy Now</a></span></span></span></li><li class="css3_grid_row_10 footer_row css3_grid_row_10_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><a href="https://www.thewebgen.com/services/?plan=2&amp;type=package&amp;postid=2387&amp;service=Startup Package" class="sign_up we">Get Started Now</a></span></span></li></ul></div>
			
			
			
			<div class="column_3 column_3_responsive" style="width: 25%;"><ul><li class="css3_grid_row_0 header_row_1 align_center css3_grid_row_0_responsive radius5_topright"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><h2 class="col1">PROFESSIONAL</h2></span></span></li><li class="css3_grid_row_1 header_row_2 css3_grid_row_1_responsive align_center">
			<span class="css3_grid_vertical_align_table">
	<span class="css3_grid_vertical_align">
	<h1 class="col1" style="font-size:30px !important;">Rs.<span style="font-size:30px !important;">9,999</span></h1>
			</span></span></li>
	<li class="css3_grid_row_2 row_style_3 css3_grid_row_2_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>10</span></span></span></li><li class="css3_grid_row_3 row_style_1 css3_grid_row_3_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>Up to 15 Revisions</span></span></span></li><li class="css3_grid_row_4 row_style_3 css3_grid_row_4_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"> </span>2</span></span></span></li><li class="css3_grid_row_5 row_style_1 css3_grid_row_5_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>2</span></span></span></li>
	<li class="css3_grid_row_6 row_style_3 css3_grid_row_6_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>✔️</span></span></span></li><li style="height: 25px;" class="css3_grid_row_7 row_style_1 css3_grid_row_7_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>✔️</span></span></span></li><li style="height: 25px;" class="css3_grid_row_8 row_style_3 css3_grid_row_8_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>✔️</span></span></span></li><li style="height: 0px;display: none;" class="css3_grid_row_9 row_style_1 css3_grid_row_9_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"><b></b></span><a href="https://www.thewebgen.com/packages/?plan=3&amp;services=logo" class="sign_up" radius3="">Buy Now</a></span></span></span></li><li class="css3_grid_row_10 footer_row css3_grid_row_10_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><a href="https://www.thewebgen.com/services/?plan=3&amp;type=package&amp;postid=2387&amp;service=Professional Package" class="sign_up we">Get Started Now</a></span></span></li></ul></div></div>

</div><div style="margin-top: 25px"></div><div class=" align-center" style="color:#121212;">

</div><div style="margin-top: 20px"></div><div class=" align-center" style="color:#ffffff;">
							...
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>Quick process of receiving, understanding and implementation</p>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>One stop solutions for all sorts of designing and printing as well</p>
									</div>
								</div>
							</div>
						</div>
