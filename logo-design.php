...
<html lang="en" class="no-js">
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background:#D43F3F">
    <div class="text-block">
      <div class="container">
        <div class="row">
...
<span>GROW TRAFFIC &amp; INCREASE REVENUE</span>
	<h2>Why Logo Should be one and Unique for your business?</h2>
	
<p style="text-align: justify">A logo is an entity that creates an image of your brand. When a person sees your logo, he should remember about your brand.</p><p> 
A logo also needs to be unique because same or common logos often bring trouble during trademark or registration as it is sometimes found that another company is already using the same or similar logo, but also has it trademark. This results in loss of time, money and efforts and other legal obligations. This is why we thrive to provide one and unique logo for your business. </p>
...
<section class="portfolio-page bg-gradient15 pad-tb">
    <div class="container">
      <div class="row justify-content-left">
		...
		<div class="container">
			<div class="row">
								<div class="lazy_box col-lg-3 col-md-4 col-sm-4 col-xs-6 ">
					...
					<div class="portfolio_box">
						<div class="portfolio_pic">
							<picture>
								<source type="image/webp" srcset="https://www.nextscreen.in/portfolio/1562860360_1561720402_logoportsmall24.webp" class=" lazyloaded">
								<source type="image/jpg" srcset="https://www.nextscreen.in/portfolio/1562860360_1561720402_logoportsmall24.jpg" class=" lazyloaded">
								<img src="https://www.nextscreen.in/portfolio/1562860360_1561720402_logoportsmall24.jpg" alt="Rise High Logo Design" class=" ls-is-cached lazyloaded">
							</picture>
							<div class="over_pic">
								<a class="fancybox" href="https://www.nextscreen.in/portfolio/1562152483_logoportbig24.jpg" data-fancybox-group="gallery"><img src="https://www.nextscreen.in/assets/images/glass.png" alt=""></a>
							</div>
							<div class="overlay_port"></div>
						</div>
						<div class="portfolio_txt">
							...
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>
A logo that is recognised and trusted will bring in more sales and profits because people will trust your brand</p>
									</div>
								</div>
							</div>
						<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>
The brand image that a company achieves is a powerful tool for gaining market leverage; when a company has created a positive brand image, it can influence its target audience's buying habits.</p>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s" style="visibility: visible; animation-delay: 1.1s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									<div class="s-card-icon"><img src="images/icons/best.png" alt="service" class="img-fluid"></div>
									<div class="s-block-content">
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s" style="visibility: visible; animation-delay: 1.7s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									<div class="s-card-icon"><img src="images/icons/gain-stra.png" alt="service" class="img-fluid"></div>
									<div class="s-block-content">
										<h4 style="font-size: 17px">Gain Strategic Advantage over Competition</h4>
										<p>
...
@media screen and (max-width:479px)
{
	...
	<li class="css3_grid_row_6 row_style_3 css3_grid_row_6_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>✔️</span></span></span></li><li style="height: 25px;" class="css3_grid_row_7 row_style_1 css3_grid_row_7_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>✔️</span></span></span></li><li style="height: 25px;" class="css3_grid_row_8 row_style_3 css3_grid_row_8_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"></span>✔️</span></span></span></li><li style="height: 0px;display: none;" class="css3_grid_row_9 row_style_1 css3_grid_row_9_responsive align_center"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><span><span class="css3_hidden_caption"><b></b></span><a href="https://www.thewebgen.com/packages/?plan=3&amp;services=logo" class="sign_up" radius3="">Buy Now</a></span></span></span></li><li class="css3_grid_row_10 footer_row css3_grid_row_10_responsive"><span class="css3_grid_vertical_align_table"><span class="css3_grid_vertical_align"><a href="https://www.thewebgen.com/services/?plan=3&amp;type=package&amp;postid=2387&amp;service=Professional Package" class="sign_up we">Get Started Now</a></span></span></li></ul></div></div>
	 ...
	 <section class="padding-6030  bg-gradient15 o-hidden " style="padding-bottom: 5%">
   <div class="container">
      <div class="row justify-content-center" >
				<div class="col-lg-8">
