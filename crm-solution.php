...
<!--End Header -->
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background: #3943f9">
    <div class="text-block">
      <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-6 tabbanrt" style="margin-top: 4%">
			 ...
			 <div class="col-sm-4 col-xs-6 tabbanrt" style="margin-top: 4%">
				<div class="service-sec-list ">
					<img src="images/icons/tech.svg" alt="service">
					<h5 class="mb10" style="color: white">Branding - The Secret Mantra of (Business) Success</h5>
					<!--<ul class="-service-list">
						<li > <a href="#" style="color: white">React.JS </a> </li>
						<li > <a href="#" style="color: white">Node.JS </a> </li>
						<li > <a href="#" style="color: white"> Angular.JS </a></li>
					</ul>-->
					<p style="color: white">Branding is THE answer to the most common, yet elemental question –
Why consumers prefer your services/products instead of your rivals?</p>
				 </div>   
			</div>
...
<div class="text-l service-desc- pr25">
	...
	<h2>Retain Your Valuable Customers with Customised CRM
Solutions</h2>
	<br>
<p style="text-align: justify">We will help you creating valuable customer relationships with the CRM software solutions
personalized based on your requirements. Our CRM software solutions help you integrating
cutting edge solutions in your daily business transactions that help you save time and cuts
expenditure while gaining and retaining more potential customers.</p>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3 class="mb20" style="color:#000">Why CRM Needed for Business? </h3>  
...
<div class="servie-key-points">
  ...
  <ul class="key-points mt20">
	...
	<li>Select Customised Marketing</li>
	<li>Enabling Targeted Sales</li>
	<li>Tailored Service Management</li>
	<li>Integrating Other SaaS Solutions</li>
	<li>Automated Billing Process</li>
	<li>Enable Online Customer Tracking</li>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="common-heading">
            <span>Service</span>
            <h2 class="mb30">Design Service</h2>
          </div>
        </div>
      </div>
      <div class="row upset link-hover">
        ...
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <h4>CRM Software Integration</h4>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            <div class="s-card-icon"><img src="images/icons/video.svg" alt="service" class="img-fluid"></div>
            <h4>CRM Software Support &amp; Maintenance</h4>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
						...
						<div class="row justify-content-center">
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Offering Supreme Reliability</h4>
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Cost Effective CRM Solutions</h4>
										<p>In vel hendrerit nisi. Vestibulum eget risus velit.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Quality Support &amp; Maintenance</h4>
										<p>In vel hendrerit nisi. Vestibulum eget risus velit.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s" style="visibility: hidden; animation-delay: 1.1s; animation-name: none;">
								<div class="s-block wide-sblock">
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s" style="visibility: hidden; animation-delay: 1.4s; animation-name: none;">
								<div class="s-block wide-sblock">
									<div class="s-card-icon"><img src="images/icons/badge.svg" alt="service" class="img-fluid"></div>
									<div class="s-block-content">
										<h4>Quick <br>Completion</h4>
										<p>In vel hendrerit nisi. Vestibulum eget risus velit.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s" style="visibility: hidden; animation-delay: 1.7s; animation-name: none;">
								<div class="s-block wide-sblock">
