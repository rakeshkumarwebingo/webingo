...
<div class="text-l service-desc- pr25">
	...
	<h2>Tame Your Operational Cost with Customised ERP
Solutions</h2>
	<br>
						...
						<div class="row">
							...
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									...
									<p>DAn MVP is a minimal form of your product that is tested on the market. This development
strategy allows your team to validate (or invalidate) product assumptions and learn how your
target users react and experience your product’s core functionality. This approach will
provide insight into properly allocating your budget to satisfy your overall business objectives.
Building an MVP is an iterative process designed to identify user pain points and determine
      ...
      <div class="row upset link-hover">
        ...
        <div class="col-lg-4 col-sm-6 mt30">
          <div class="s-block">
            ...
            <h4>Accounting &amp; Consolidation</h4>
            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
            <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
          </div>
        </div>
...
<div class="text-l service-desc- pr25">
  ...
  <p>A major impediment for evolved businesses such as manufacturing and supply chain is an
