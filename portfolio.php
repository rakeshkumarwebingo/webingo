...
<html lang="en" class="no-js">
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background:#ff5c33">
    <div class="text-block">
      <div class="container">
        <div class="row">
...
<section class="digtialmarketinggpage protfoliopage">
	<div class="cmscontainpage top_content_top">
		<div class="container">
			<div class="topHeading">
				<h1>Excellent portfolio of Webingo .</h1>	
				<div class="desktextnone"></div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-sm-6 col-xs-6">
					<div class="portfolio_thumb">
						<div class="portfolio_thumb_pic">
							<picture>
								<source type="image/webp" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img1.webp">
								<source type="image/jpg" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img1.jpg">
								<img src="https://www.nextscreen.in/assets/images/portfolio-new-img1.jpg" alt="">
							</picture>
							<div class="portfolio_thumb_txt">
								<h3>Web Design</h3>
								<p>Web designing Services</p>
							</div>
							<div class="portfolio_thumb_hover">
								<div class="portfolio_thumb_hoverBox">
									<span class="hover_heading">Web Design</span>
				...
				<div class="col-sm-6 col-xs-6">
					<div class="portfolio_thumb">
						<div class="portfolio_thumb_pic">
							<picture>
								<source type="image/webp" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img2.webp">
								<source type="image/jpg" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img2.jpg">
								<img src="https://www.nextscreen.in/assets/images/portfolio-new-img2.jpg" alt="">
							</picture>
							<div class="portfolio_thumb_txt">
								<h3>Logo Design</h3>
								<p>Logo designing Services</p>
							</div>
							<div class="portfolio_thumb_hover">
								<div class="portfolio_thumb_hoverBox">
									<span class="hover_heading">Logo Design</span>
									<a class="view_more" href="#">View More</a>
								</div>
							</div>
						</div>
				...
				<div class="col-sm-6 col-xs-6">
					<div class="portfolio_thumb">
						<div class="portfolio_thumb_pic">
							<picture>
								<source type="image/webp" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img3.webp">
								<source type="image/jpg" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img3.jpg">
								<img src="https://www.nextscreen.in/assets/images/portfolio-new-img3.jpg" alt="">
							</picture>
							<div class="portfolio_thumb_txt">
								<h3>Business Card Design</h3>
								<p>Business Card designing Services</p>
							</div>
							<div class="portfolio_thumb_hover">
								<div class="portfolio_thumb_hoverBox">
									<span class="hover_heading">Business Card Design</span>
									<a class="view_more" href="#">View More</a>
								</div>
							</div>
						</div>
				...
				<div class="col-sm-6 col-xs-6">
					<div class="portfolio_thumb">
						<div class="portfolio_thumb_pic">
							<picture>
								<source type="image/webp" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img4.webp">
								<source type="image/jpg" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img4.jpg">
								<img src="https://www.nextscreen.in/assets/images/portfolio-new-img4.jpg" alt="">
							</picture>
							<div class="portfolio_thumb_txt">
							...
							<div class="portfolio_thumb_hover">
								<div class="portfolio_thumb_hoverBox">
									<span class="hover_heading">Graphic Design</span>
									<a class="view_more" href="#">View More</a>
								</div>
							</div>
						</div>
				...
				<div class="col-sm-6 col-xs-6">
					<div class="portfolio_thumb">
						<div class="portfolio_thumb_pic">
							<picture>
								<source type="image/webp" srcset="https://www.nextscreen.in/assets/images/Packaging-Design.webp">
								<source type="image/jpg" srcset="https://www.nextscreen.in/assets/images/Packaging-Design.jpg">
								<img src="https://www.nextscreen.in/assets/images/portfolio-new-img5.jpg" alt="">
							</picture>
							<div class="portfolio_thumb_txt">
								<h3>Packaging Design </h3>
								<p>Packaging designing Services</p>
							</div>
							<div class="portfolio_thumb_hover">
								<div class="portfolio_thumb_hoverBox">
									<span class="hover_heading">Packaging Design </span>
									<a class="view_more" href="#">View More</a>
								</div>
							</div>
						</div>
				...
				<div class="col-sm-6 col-xs-6">
					<div class="portfolio_thumb">
						<div class="portfolio_thumb_pic">
							<picture>
								<source type="image/webp" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img6.webp">
								<source type="image/jpg" srcset="https://www.nextscreen.in/assets/images/portfolio-new-img6.jpg">
								<img src="https://www.nextscreen.in/assets/images/portfolio-new-img6.jpg" alt="">
							</picture>
							<div class="portfolio_thumb_txt">
								<h3>Wordpress Design</h3>
								<p>Wordpress designing Services</p>
							</div>
							<div class="portfolio_thumb_hover">
								<div class="portfolio_thumb_hoverBox">
									<span class="hover_heading">Wordpress Design</span>
									<a class="view_more" href="#">View More</a>
								</div>
							</div>
						</div>
