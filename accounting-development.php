...
<!--End Header -->
 ...
 <!-- <section class="breadcrumb-area pink banner-2" style="padding-bottom: 0px">
    ...
    margin-top: 179px;">
	    ...
	    <!--Breadcrumb Area-->
  <section class="breadcrumb-area " style="padding: 32px 0px 32px 0px;background:#F76B6C">
    <div class="text-block">
      <div class="container">
        <div class="row">
...
<section class="service-section pad-tb bg-gradient15">
<div class="container">
<div class="row justify-content-center">
<div class="col-lg-8">
<div class="common-heading">
<span>Services We’re Provided</span>
<h2 class="mb30">Our Key Features?</h2>
...
<div class="col-lg-7">
<div class="text-l service-desc- pr25">
  <h3>What Benefits will you get?</h3>
...
<div class="servie-key-points">
  <h4>Advantages of Accounting Software Development</h4>
						...
						<div class="row justify-content-center">
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Cost Effective Accounting Solutions</h4>
										<p>In vel hendrerit nisi. Vestibulum eget risus velit.</p>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s" style="visibility: visible; animation-delay: 1.7s; animation-name: fadeIn;">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										<h4>Built with the help of Experts in Accounts</h4>
										<p>In vel hendrerit nisi. Vestibulum eget risus velit.</p>
									</div>
								</div>
							</div>
